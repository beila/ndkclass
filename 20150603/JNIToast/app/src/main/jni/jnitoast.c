...
JNIEXPORT void JNICALL Java_com_example_jnitoast_LoginActivity_nativeToast
  (JNIEnv *pEnv, jobject thiz, jobject context, jstring msg, jint length) {
    ...
    jobject toast = (*pEnv)->CallStaticObjectMethod(pEnv, toastClass, makeTextMethod, context, msg, length);
